...
def create_spec_reject_const(fname: str, val: int=INT32_MAX / 2) -> np.ndarray:
    NUM_GROUPS = 1
    data = val * np.ones((NUM_GROUPS, NUM_SPECTRA, SPECTRUM_LEN), dtype=np.int32)
...
class Test_Reject1(Test):
    ...
    default_options = {
        "avg_mode": "int",
        "cdi_delay": 0,
        "data_gen_func": "create_spec_reject_const"
    ...
    def generate_script(self):
        ...
        self.true_data = data_func(self.spectrum_fname)
