...
class Test_Reject(Test):
    ...
    def generate_script(self):
        ...
        scripter.reset()
        scripter.wait(1)
        scripter.set_Navg(14,3) # average = 2^3
        scripter.set_reject(128, 20) # set condition for rejecting -- if more than 20 are more than 128 off
        scripter.start()
        scripter.wait(5)
        ## inject 1000 outliers that are x2 in amplitude and type = 0 (spectrum independent)
        scripter.inject_outlier(num=50,amp=2,bins=1)
        scripter.wait(5)
